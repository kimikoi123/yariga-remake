    ...
    <div>
      ...
      <div className="rounded-2xl flex flex-col gap-5">
        <div className="flex gap-16 items-center bg-white rounded-3xl">
          <div className="bg-[url('src/assets/random.jpg')] w-[300px] h-[300px] bg-cover rounded-l-3xl p-5 relative flex flex-col justify-end items-start">
            <div className="flex bg-gray-100 p-3 rounded-lg">
              <img src="src/assets/camera-icon.svg" alt="" />
              <div>Change Photo</div>
            </div>
            <img className="absolute translate-x-1/2 top-12 right-0 w-[80px] h-[80px]" src="src/assets/profile-02.png" alt="" />
          </div>
            ...
            <div className="w-[500px] flex flex-col gap-5 mt-5">
              <div>
                ...
                <div className="flex gap-3 border p-2 rounded">
                  <img className="text-black" src="src/assets/location-icon.svg" alt="" />
